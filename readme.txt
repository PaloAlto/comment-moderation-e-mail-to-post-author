=== Send Comment Moderation E-mail ONLY to the Post Author ===
Contributors: RavanH
...
Allows the comment moderation notification to be sent ONLY to the post author and no longer to the site E-mail Address too.

== Description ==

This plugin could also have been called **Don't bother the Site Admin with every author's Moderation Messages, unless Site Admin is the author or the author has no moderation rights** but since that's a slightly long title, I chose to keep it as simple as I could. However, it explains well what this plugin does:
